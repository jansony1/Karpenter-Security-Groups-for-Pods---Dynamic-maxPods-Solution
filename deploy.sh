...
echo "   kubectl apply -f test/test-multi-instances.yaml"
echo ""
echo "2. 测试中等实例类型 (m5.xlarge等):"
echo "   kubectl apply -f test/test-pod.yaml"
echo ""
echo "3. 测试特定实例类型:"
echo "   kubectl apply -f test/trigger-c5-large-small.yaml  # c5.large"
echo "   kubectl apply -f test/trigger-m5-xlarge.yaml       # m5.xlarge"
echo ""
echo "4. 监控节点创建:"
